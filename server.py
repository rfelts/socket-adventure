...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def connect(self):
        ...
        # Set an option to deal with the port is already used error.
    ...
    def room_description(self, room_number):
        ...
        return[
            "You are in the sci-fi room.",
            "You are in the horror room.",
            "You are in the fantasy room.",
            "You are in the adventure room.",
        ][room_number]
    ...
    def move(self, argument):
        ...
        * "west"
        ...
        if self.room == 0 and argument == "north":
            ...
            self.output_buffer = "Can't go that way. " # + self.room_description(self.room)
    ...
    def push_output(self):
        ...
        # Clear the output buffer for the next call
        self.output_buffer = ""
